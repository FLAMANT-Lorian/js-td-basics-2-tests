...
if (consoKW <= 30 && consoKW >= 0){
    cost = consoKW * 25;
} else if (consoKW > 30 && consoKW <= 50){
    cost = (consoKW * 20) + (5 * 30);
} else if (consoKW > 50 && consoKW <= 70){
    cost = (consoKW * 15) + (10 * 30) + (20 * 5);
} else if (consoKW > 70){
    cost = (consoKW * 10) + (15 * 30) + (20 * 10) + (20 * 5);
} else {
    console.log('Veuillez entrer un consommation correct');
}

console.log(`Le prix à payer est de ${cost / 100} €.`);